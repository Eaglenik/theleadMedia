<template>
  <section class="header">
    <div class="header-back my-container">
        <div class="header-text">
           <h1>{{ currentServicesService.title }}</h1>
           <p>{{ currentServicesService.content }}</p>
            <mainButton @click="showModal = true">{{currentServicesService.btnText}}</mainButton>
        </div>
    </div>
  ...
  <section class="breadcrumbs my-container">
    <b-breadcrumb class="breadcrumbs-links">
      ...
      <span class="breadcrumb-icon"><img src="@/assets/images/icons/chevroneBread.svg"/></span>
      <b-breadcrumb-item  active>{{ currentServicesService.title }}</b-breadcrumb-item>
    </b-breadcrumb>
  </section>
  <section class="service-main my-container">
    <div class="service-content" >
      <div class="service-description" >
        <p v-html="currentServicesService.serviceDescription"></p>
      </div>
      <div class="points" id="list-item-3">
        <h6 class="title" v-html="currentServicesService.pointTitleOne" ></h6>
        <div class="d-flex justify-content-between flex-wrap gap-4">
          <div class="service-point">
            ...
            <h6>{{currentServicesService.titlePointOne}}</h6>
            <p>{{currentServicesService.descriptionPointOne}}</p>
          </div>
          <div class="service-point">
            <div class="service-point_img">
                <img src="@/assets/images/chevrone.png" alt="">
            ...
            <h6>{{currentServicesService.titlePointTwo}}</h6>
            <p>{{currentServicesService.descriptionPointTwo}}</p>
          </div>
          <div class="service-point">
            <div class="service-point_img">
                <img src="@/assets/images/chevrone.png" alt="">
            ...
            <h6>{{currentServicesService.titlePointThree}}</h6>
            <p>{{currentServicesService.descriptionPointThree}}</p>
          </div>
          <div class="service-point">
            <div class="service-point_img">
                <img src="@/assets/images/chevrone.png" alt="">
            ...
            <h6>{{currentServicesService.titlePointFour}}</h6>
            <p>{{currentServicesService.descriptionPointFour}}</p>
          </div>
        </div>
      </div>
      <div class="aboutService" id="list-item-4">
        <h6 class="title" v-html="currentServicesService.aboutServiceTitleOne" ></h6>
        <div class="aboutService-first">
          <span>{{ currentServicesService.aboutServiceTitleText1 }}</span>
          <p>{{ currentServicesService.aboutServiceDescriptionText1 }}</p>
        </div>
        <div class="aboutService-first">
          <span>{{ currentServicesService.aboutServiceTitleText2 }}</span>
          <p>{{ currentServicesService.aboutServiceDescriptionText2 }}</p>
        </div>
        <div class="aboutService-first">
          <span>{{ currentServicesService.aboutServiceTitleText3 }}</span>
          <p>{{ currentServicesService.aboutServiceDescriptionText3 }}</p>
        </div>
        <div class="aboutService-first">
          <span>{{ currentServicesService.aboutServiceTitleText4 }}</span>
          <p>{{ currentServicesService.aboutServiceDescriptionText4 }}</p>
        </div>
        <div class="aboutService-first">
          <span>{{ currentServicesService.aboutServiceTitleText5 }}</span>
          <p>{{ currentServicesService.aboutServiceDescriptionText5 }}</p>
        </div>
      </div>
      <div class="aboutService" id="list-item-5">
        <h6 class="title" v-html="currentServicesService.aboutServiceTitleTwo" ></h6>
        <ul>
          <li><span>{{ currentServicesService.aboutServiceTitleList1 }}</span></li>
          <li><span>{{ currentServicesService.aboutServiceTitleList2 }}</span></li>
          <li><span>{{ currentServicesService.aboutServiceTitleList3 }}</span></li>
        </ul>
        <p v-html="currentServicesService.aboutServiceDescriptionList1"></p>
      </div>
      ...
      <div class="points" id="list-item-7">
        <h6 class="title" v-html="currentServicesService.pointTitleTwo" ></h6>
        <div class="d-flex justify-content-between flex-wrap gap-4">
          <div class="service-point">
            <div class="service-point_img">
                <img src="@/assets/images/chevrone.png" alt="">
            ...
            <h6>{{currentServicesService.title2PointOne}}</h6>
            <p>{{currentServicesService.description2PointOne}}</p>
          </div>
          <div class="service-point">
            <div class="service-point_img">
                <img src="@/assets/images/chevrone.png" alt="">
            ...
            <h6>{{currentServicesService.title2PointTwo}}</h6>
            <p>{{currentServicesService.description2PointTwo}}</p>
          </div>
          <div class="service-point">
            <div class="service-point_img">
                <img src="@/assets/images/chevrone.png" alt="">
            ...
            <h6>{{currentServicesService.title2PointThree}}</h6>
            <p>{{currentServicesService.description2PointThree}}</p>
          </div>
          <div class="service-point">
            <div class="service-point_img">
                <img src="@/assets/images/chevrone.png" alt="">
            ...
            <h6>{{currentServicesService.title2PointFour}}</h6>
            <p>{{currentServicesService.description2PointFour}}</p>
          </div>
          <div class="service-point">
            <div class="service-point_img">
                <img src="@/assets/images/chevrone.png" alt="">
            ...
            <h6>{{currentServicesService.title2PointFive}}</h6>
            <p>{{currentServicesService.description2PointFive}}</p>
          </div>
          <div class="service-point">
            <div class="service-point_img">
                <img src="@/assets/images/chevrone.png" alt="">
            ...
            <h6>{{currentServicesService.title2PointSix}}</h6>
            <p>{{currentServicesService.description2PointSix}}</p>
          </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  created() {
      ...
      this.currentServicesService = this.servicesService.find(
        servicesService => servicesService.slug === this.currentSlug
      )
  },
  watch: {
