<template>
    ...
    <div class="my-container">
        <section class="breadcrumbs">
            ...
            <b-breadcrumb-item  active>Контакты</b-breadcrumb-item>
            </b-breadcrumb>
        </section>
        <section class="contact d-flex justify-content-between flex-xl-row flex-column gap-5">
